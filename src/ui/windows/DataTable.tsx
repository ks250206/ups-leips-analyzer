...
import type { Point, SpectrumDataset } from "../../domain/types";
...
export function DataTable() {
  ...
  return <DatasetTable dataset={selected} />;
}

function DatasetTable({ dataset }: { dataset: SpectrumDataset }) {
